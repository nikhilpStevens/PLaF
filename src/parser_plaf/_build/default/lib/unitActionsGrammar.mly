...
%right ARROW SET
%right LISTTYPE QUEUETYPE REFTYPE SETTYPE STACKTYPE TREETYPE
...
loption_separated_nonempty_list_COMMA_texpr__:
  
    {} [@name none_separated_nonempty_list_COMMA_texpr_]
| separated_nonempty_list_COMMA_texpr_
    {} [@name some_separated_nonempty_list_COMMA_texpr_]
...
list_iface_or_class_or_module_decl_:
  
    {} [@name nil_iface_or_class_or_module_decl]
| iface_or_class_or_module_decl list_iface_or_class_or_module_decl_
    {} [@name cons_iface_or_class_or_module_decl]
...
nonempty_list_case_branch_:
  case_branch
    {} [@name one_case_branch]
| case_branch nonempty_list_case_branch_
    {} [@name more_case_branch]

nonempty_list_constructor_decl_:
  constructor_decl
    {} [@name one_constructor_decl]
| constructor_decl nonempty_list_constructor_decl_
    {} [@name more_constructor_decl]
...
separated_nonempty_list_COMMA_texpr_:
  texpr
    {} [@name one_COMMA_texpr]
| texpr COMMA separated_nonempty_list_COMMA_texpr_
    {} [@name more_COMMA_texpr]
...
prog:
  list_iface_or_class_or_module_decl_ expr EOF
    {}
...
| OPEN ID IN expr
    {}
| CONSTRUCTOR LPAREN loption_separated_nonempty_list_COMMA_expr__ RPAREN
    {}
| CASE expr OF LBRACE nonempty_list_case_branch_ RBRACE
    {}
| TYPE ID EQUALS nonempty_list_constructor_decl_
    {}
...
| INTERFACE ID LBRACE list_abstract_method_decl_ RBRACE
    {}
| MODULE ID INTERFACE minterfc BODY mbody
    {}

minterfc:
  LBRACKET list_mvdecl_ RBRACKET
    {}
...
| OPAQUE ID
    {}
| TRANSPARENT ID EQUALS texpr
    {}

mbody:
  LBRACKET list_mvdef_ RBRACKET
    {}

mvdef:
  ID EQUALS expr
    {}
| TYPE ID EQUALS texpr
    {}
...
case_branch:
  CONSTRUCTOR LPAREN loption_separated_nonempty_list_COMMA_ID__ RPAREN ARROW expr
    {}

constructor_decl:
  PIPE CONSTRUCTOR LPAREN loption_separated_nonempty_list_COMMA_texpr__ RPAREN
    {}

texpr:
  ID
    {}
| SINGLE_RIGHT_QUOTATION_MARK ID
    {}
| INTTYPE
    {}
| BOOLTYPE
